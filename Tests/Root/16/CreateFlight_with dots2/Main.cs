    ...
    *  in HP Service Test.
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            VTDPropertyInfoBase pi145 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter73 = new VTDObjectGetter(pi145);
            VTDPropertyInfoBase pi146 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter73 = new VTDObjectSetter(pi146);
            binding_setter73 = new StringFormaterDecorator(binding_setter73,"{Step.DataFetchActivity17.OutTable}");
            bind_dir73 = new BindDirection(_flow.DataFetchActivity17,binding_getter73,binding_setter73,BindTargetType.ToInProperty);
            _flow.DataExporterActivity19.InDirections.Add(bind_dir73);
            ...
            VTDPropertyInfoBase pi147 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter74 = new VTDObjectGetter(pi147);
            VTDPropertyInfoBase pi148 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter74 = new VTDObjectSetter(pi148);
            binding_setter74 = new StringFormaterDecorator(binding_setter74,"{Step.DataFetchActivity20.OutTable}");
            bind_dir74 = new BindDirection(_flow.DataFetchActivity20,binding_getter74,binding_setter74,BindTargetType.ToInProperty);
            _flow.DataExporterActivity22.InDirections.Add(bind_dir74);
            ...
            VTDPropertyInfoBase pi149 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter75 = new VTDObjectGetter(pi149);
            VTDPropertyInfoBase pi150 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter75 = new VTDObjectSetter(pi150);
            binding_setter75 = new StringFormaterDecorator(binding_setter75,"{Step.DataFetchActivity17.OutTable}");
            bind_dir75 = new BindDirection(_flow.DataFetchActivity17,binding_getter75,binding_setter75,BindTargetType.ToInProperty);
            _flow.DataDisconnectActivity18.InDirections.Add(bind_dir75);
            ...
            VTDPropertyInfoBase pi151 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter76 = new VTDObjectGetter(pi151);
            VTDPropertyInfoBase pi152 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter76 = new VTDObjectSetter(pi152);
            binding_setter76 = new StringFormaterDecorator(binding_setter76,"{Step.DataFetchActivity20.OutTable}");
            bind_dir76 = new BindDirection(_flow.DataFetchActivity20,binding_getter76,binding_setter76,BindTargetType.ToInProperty);
            _flow.DataDisconnectActivity21.InDirections.Add(bind_dir76);
            this.Activities.Add (_flow.DataDisconnectActivity21);
            this.DataCursorActivity24.Comment = @"";
            this.DataCursorActivity24.IconPath = @"";
            VTDPropertyInfoBase pi153 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter77 = new VTDObjectGetter(pi153);
            VTDPropertyInfoBase pi154 = new VTDPropertyInfoBase("InTable");
            VTDBaseSetter binding_setter77 = new VTDObjectSetter(pi154);
            binding_setter77 = new StringFormaterDecorator(binding_setter77,"{Step.DataFetchActivity17.OutTable}");
            bind_dir77 = new BindDirection(_flow.DataFetchActivity17,binding_getter77,binding_setter77,BindTargetType.ToInProperty);
            this.DataCursorActivity24.InDirections.Add(bind_dir77);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.FlidhtInfo!Input.DepartureCity}</DepartureCity><ArrivalCity>{DataSource.FlidhtInfo!Input.ArrivalCity}</ArrivalCity><FlightDate>{DataSource.FlidhtInfo!Input.DepartureDate}</FlightDate></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi155 = new VTDPropertyInfoBase("DepartureDate");
            VTDBaseGetter binding_getter78 = new VTDObjectGetter(pi155);
            VTDPropertyInfoBase pi156 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='FlightDate'][1]");
            VTDBaseSetter binding_setter78 = new VTDXPathSetter(pi156,XmlTypeCode.DateTime);
            bind_dir78 = new BindDirection(this.DataCursorActivity24,binding_getter78,binding_setter78,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity9.InDirections.Add(bind_dir78);
            VTDPropertyInfoBase pi157 = new VTDPropertyInfoBase("DepartureCity");
            VTDBaseGetter binding_getter79 = new VTDObjectGetter(pi157);
            VTDPropertyInfoBase pi158 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='DepartureCity'][1]");
            VTDBaseSetter binding_setter79 = new VTDXPathSetter(pi158,XmlTypeCode.String);
            binding_setter79 = new StringFormaterDecorator(binding_setter79,"{DataSource.FlidhtInfo!Input.DepartureCity}");
            bind_dir79 = new BindDirection(this.DataCursorActivity24,binding_getter79,binding_setter79,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity9.InDirections.Add(bind_dir79);
            VTDPropertyInfoBase pi159 = new VTDPropertyInfoBase("ArrivalCity");
            VTDBaseGetter binding_getter80 = new VTDObjectGetter(pi159);
            VTDPropertyInfoBase pi160 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='ArrivalCity'][1]");
            VTDBaseSetter binding_setter80 = new VTDXPathSetter(pi160,XmlTypeCode.String);
            binding_setter80 = new StringFormaterDecorator(binding_setter80,"{DataSource.FlidhtInfo!Input.ArrivalCity}");
            bind_dir80 = new BindDirection(this.DataCursorActivity24,binding_getter80,binding_setter80,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity9.InDirections.Add(bind_dir80);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>{DataSource.FlidhtInfo!Input.Class}</Class><CustomerName>{DataSource.FlidhtInfo!Input.CustomerName}</CustomerName><DepartureDate>{DataSource.FlidhtInfo!Input.DepartureDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity9.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>{DataSource.FlidhtInfo!Input.NumberOfTickets}</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi161 = new VTDPropertyInfoBase("NumberOfTickets");
            VTDBaseGetter binding_getter81 = new VTDObjectGetter(pi161);
            VTDPropertyInfoBase pi162 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='NumberOfTickets'][1]");
            VTDBaseSetter binding_setter81 = new VTDXPathSetter(pi162,XmlTypeCode.Int);
            bind_dir81 = new BindDirection(this.DataCursorActivity24,binding_getter81,binding_setter81,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity11.InDirections.Add(bind_dir81);
            VTDPropertyInfoBase pi163 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='FlightNumber'][1]");
            VTDBaseGetter binding_getter82 = new VTDXPathGetter(pi163,XmlTypeCode.Int);
            binding_getter82 = new XPathGetterDecorator(binding_getter82,"{Array0}",1);
            VTDPropertyInfoBase pi164 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='FlightNumber'][1]");
            VTDBaseSetter binding_setter82 = new VTDXPathSetter(pi164,XmlTypeCode.Int);
            bind_dir82 = new BindDirection(_flow.StServiceCallActivity9,binding_getter82,binding_setter82,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity11.InDirections.Add(bind_dir82);
            VTDPropertyInfoBase pi165 = new VTDPropertyInfoBase("DepartureDate");
            VTDBaseGetter binding_getter83 = new VTDObjectGetter(pi165);
            VTDPropertyInfoBase pi166 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='DepartureDate'][1]");
            VTDBaseSetter binding_setter83 = new VTDXPathSetter(pi166,XmlTypeCode.DateTime);
            bind_dir83 = new BindDirection(this.DataCursorActivity24,binding_getter83,binding_setter83,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity11.InDirections.Add(bind_dir83);
            VTDPropertyInfoBase pi167 = new VTDPropertyInfoBase("CustomerName");
            VTDBaseGetter binding_getter84 = new VTDObjectGetter(pi167);
            VTDPropertyInfoBase pi168 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='CustomerName'][1]");
            VTDBaseSetter binding_setter84 = new VTDXPathSetter(pi168,XmlTypeCode.String);
            binding_setter84 = new StringFormaterDecorator(binding_setter84,"{DataSource.FlidhtInfo!Input.CustomerName}");
            bind_dir84 = new BindDirection(this.DataCursorActivity24,binding_getter84,binding_setter84,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity11.InDirections.Add(bind_dir84);
            VTDPropertyInfoBase pi169 = new VTDPropertyInfoBase("Class");
            VTDBaseGetter binding_getter85 = new VTDObjectGetter(pi169);
            VTDPropertyInfoBase pi170 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='Class'][1]");
            VTDBaseSetter binding_setter85 = new VTDXPathSetter(pi170,XmlTypeCode.String);
            binding_setter85 = new StringFormaterDecorator(binding_setter85,"{DataSource.FlidhtInfo!Input.Class}");
            bind_dir85 = new BindDirection(this.DataCursorActivity24,binding_getter85,binding_setter85,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity11.InDirections.Add(bind_dir85);
...
@"<Arguments><tOrderNumber>{Step.OutputProperties.StServiceCallActivity11.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber}</tOrderNumber><tPassengerName>{Step.InputProperties.StServiceCallActivity11.Body.CreateFlightOrder.FlightOrder.CustomerName}</tPassengerName></Arguments>");
            ...
            VTDPropertyInfoBase pi171 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='CustomerName'][1]");
            VTDBaseGetter binding_getter86 = new VTDXPathGetter(pi171,XmlTypeCode.String);
            VTDPropertyInfoBase pi172 = new VTDPropertyInfoBase("InputArguments","/*[local-name(.)='Arguments'][1]/*[local-name(.)='tPassengerName'][1]");
            VTDBaseSetter binding_setter86 = new VTDXPathSetter(pi172,XmlTypeCode.String);
            binding_setter86 = new StringFormaterDecorator(binding_setter86,"{Step.InputProperties.StServiceCallActivity11.Body.CreateFlightOrder.FlightOrder.CustomerName}");
            bind_dir86 = new BindDirection(_flow.StServiceCallActivity11,binding_getter86,binding_setter86,BindTargetType.ToInProperty);
            _flow.CallQTPTest12.InDirections.Add(bind_dir86);
            VTDPropertyInfoBase pi173 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrderResponse'][1]/*[local-name(.)='CreateFlightOrderResult'][1]/*[local-name(.)='OrderNumber'][1]");
            VTDBaseGetter binding_getter87 = new VTDXPathGetter(pi173,XmlTypeCode.Int);
            VTDPropertyInfoBase pi174 = new VTDPropertyInfoBase("InputArguments","/*[local-name(.)='Arguments'][1]/*[local-name(.)='tOrderNumber'][1]");
            VTDBaseSetter binding_setter87 = new VTDXPathSetter(pi174,XmlTypeCode.String);
            binding_setter87 = new StringFormaterDecorator(binding_setter87,"{Step.OutputProperties.StServiceCallActivity11.Body.CreateFlightOrderResponse.CreateFlightOrderResult.OrderNumber}");
            bind_dir87 = new BindDirection(_flow.StServiceCallActivity11,binding_getter87,binding_setter87,BindTargetType.ToInProperty);
            _flow.CallQTPTest12.InDirections.Add(bind_dir87);
